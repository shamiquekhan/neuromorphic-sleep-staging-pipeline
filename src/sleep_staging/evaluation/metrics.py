"""Metric computation for sleep-stage classification."""
...
def compute_all_metrics(
    ...
    mgm, report, confusion_matrix, per_class_accuracy, per_class.
    """
    ...
    precisions, r, f1s, supports = precision_recall_fscore_support(
